...
//	}
	...
	public static Mobile getMobile(String mobileType) {
		if (mobileType.trim().equalsIgnoreCase("Apple_iphone15")) {
			return new Apple_iphone15();
		} else if (mobileType.trim().equalsIgnoreCase("Samsung_J7")) {
			return new Samsung_J7();
		} else if (mobileType.trim().equalsIgnoreCase("Sony_Xperia10")) {
			return new Sony_Xperia10();
		} else {
			return null;
		}
